...
local Library do 
    ...
    local CustomFont = { } do
        function CustomFont:New(Name, Weight, Style, Data)
            ...
            local fontPath = Library.Folders.Fonts .. "/" .. Name .. ".font"
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                SubTitle = Data.SubTitle or Data.subtitle or "for KR Murder",
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            local Dropdown = {
                ...
                Search = Data.Search == nil and true or Data.Search,
            ...
            function Dropdown:ApplyFilter(Query)
                Dropdown.Filter = string.lower(Query or "")

                for _, OptionData in Dropdown.Options do
                    local visible = Dropdown.Filter == "" or string.find(string.lower(OptionData.Name), Dropdown.Filter, 1, true) ~= nil
                    OptionData.Button.Instance.Visible = visible
                end
            end
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    Items["Search"].Instance.Text = Dropdown.Filter
                    ...
                    Dropdown:ApplyFilter(Items["Search"].Instance.Text)
                else
            ...
            function Dropdown:Add(Option)
                ...
                Dropdown:ApplyFilter(Dropdown.Filter)
                return OptionData
            end
...
--[[
Usage:
local Library = loadstring(readfile("LibraryLoad.lua"))()
